...
use Zzlx\Encrypt\Prpcrypt;
use Zzlx\Encrypt\SHA1;

/**
 * 对企业微信发送给企业的消息加解密示例代码.
 * 1.企业收到企业微信发送的消息，验证消息的安全性，并对消息进行解密。
 * 2.企业回复加密消息给企业微信；
 */
class MsgCrypt
{
